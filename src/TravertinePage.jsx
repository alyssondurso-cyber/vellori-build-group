      ...
      <section className="px-6 py-24 lg:px-10">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-5 font-serif text-4xl md:text-6xl">
            Travertine services in Boca Raton and surrounding areas.
          </h2>

          <p className="mt-7 max-w-3xl leading-8 text-[#0D1B2A]/65">
            VELLORI supports residential travertine and exterior improvement
            projects across Boca Raton and surrounding South Florida
            communities.
          </p>
