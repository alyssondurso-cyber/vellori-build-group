...
const serviceGroups = [
  ...
  "Exterior Stucco",
  "EIFS Installation & Exterior Finish Systems",
  "Smooth Stucco Finish",
  "Textured Stucco Finish",
  "Spanish Texture Stucco Finish",
  ...
  },
  {
    ...
    href: "/project-request",
    description:
      "Selective demolition support and preparation that help projects move into the next construction or finishing phase in an organized manner.",
    items: [
      "Selective Demolition Support",
      "Tile Removal Support",
      "Stone Removal Support",
      "Concrete Removal Support",
      "Existing Finish Removal Support",
      "Surface Preparation",
      "Debris Removal",
      "Project Preparation",
    ],
  },
  {
    ...
    href: "/project-request",
    description:
      "Selected residential interior finish support scopes approached with the same attention to detail applied to VELLORI exterior projects.",
    items: [
      "Drywall Repair Support",
      "Drywall Finishing Support",
      "Interior Tile Installation Support",
      "Flooring & Surface Improvement Support",
      "Interior Finish Work Support",
