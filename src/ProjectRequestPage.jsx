...
export default function ProjectRequestPage() {
  return (
    <main className="min-h-screen bg-[#F3EFE6] text-[#0D1B2A]">
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-10 lg:py-24"><div className="mx-auto max-w-5xl"><div className="mb-9 flex flex-wrap items-end justify-between gap-5"><div><p className="text-xs uppercase tracking-[0.35em] text-[#C8A96B]">VELLORI Build Group</p><h2 className="mt-4 font-serif text-4xl md:text-5xl">Project Estimate &amp; Site Visit Request</h2></div><a href="mailto:info@velloribuild.com" className="inline-flex items-center gap-2 text-sm text-[#0D1B2A]/65 hover:text-[#9B7A3F]"><Mail className="h-4 w-4"/> info@velloribuild.com</a></div><div className="border border-[#0D1B2A]/10 bg-white p-8 shadow-[0_18px_60px_rgba(13,27,42,0.08)] md:p-12"><p className="max-w-3xl font-serif text-3xl leading-tight md:text-4xl">Share your project details in a private, secure request.</p><p className="mt-6 max-w-3xl text-base leading-8 text-[#0D1B2A]/65">Upload photos or videos, request an on-site visit, or choose a convenient time for our team to call you.</p><a href={FORM_URL} target="_blank" rel="noreferrer" className="mt-9 inline-flex w-full items-center justify-center gap-3 bg-[#0D1B2A] px-7 py-5 text-xs uppercase tracking-[0.20em] text-white transition hover:bg-[#C8A96B] hover:text-[#0D1B2A] sm:w-auto">Open Secure Project Request <ArrowRight className="h-4 w-4"/></a></div><p className="mt-6 text-center text-sm leading-7 text-[#0D1B2A]/60">Photo-based feedback and preliminary ranges are not final estimates. Final pricing depends on site conditions, measurements, materials, scope, access, permits, and any required licensed-trade coordination.</p></div></section>
